...
"""
apellidos_list = apellidos.split(',',1)
...
"""
#var2 = decimales.list[38]
#var2 = int(float(var2.replace( ',','.')))
#print(var2)
...
"""
apellido2 = apellido.lstrip()
apellido2 = apellido.rstrip()

len_apellido = len(apellido2)
print (len_apellido)
